...
<head>
    ...
    <noscript>
        <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=404613343232744&ev=PageView&noscript=1" />
    </noscript>
    <!-- google analytics -->
    ...
    <link rel="icon" href="public/images/logo-icon.ico" type="image/png" sizes="16x16">
    ...
    <!--ZOOM-->
    <link rel="stylesheet" href="public/css/demo.css?v=1" />
    <link rel="stylesheet" href="public/css/imagezoom.css" />
    <link rel="stylesheet" href="public/css/es-cus.css" />
    <!-- end: ZOOM-->
    <link href="public/css/styles.css" rel="stylesheet" type="text/css" />
    <link href="public/css/reponsive.css" rel="stylesheet" type="text/css" />
    <link href="public/css/styles_ts.css?v=125" rel="stylesheet" type="text/css" />

    <!-- smart menu -->
    <!-- SmartMenus core CSS (required) -->
    <!-- "sm-blue" menu theme (optional, you can use your own CSS, too) -->
    <link href='public/css/sm-simple.css' rel='stylesheet' type='text/css' />
    ...
    <script src="public/js/jquery.number.js" type="text/javascript"></script>
    <script src="public/js/affix.js" type="text/javascript"></script>
    ...
    <script type="text/javascript" src="public/js/modernizr.custom.17475.js"></script>
...
<body>
    ...
    <nav id="topBar" class="navbar navbar-default">
        <div class="container">
            <div class="navbar-header col-md-2 col-sm-2">
                <a class="navbar-brand" href="https://ivymoda.com/"><img src="public/images/logo.png" /></a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar_center">
                    ...
                    <!--<li class="dropdown">-->
                    <!--&lt;!&ndash; fixed cho sale &ndash;&gt;-->
                    <!--<a href="#" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false" style="color: red">Khẩu trang - Bộ bảo hộ</a>-->
                    <!--<ul class="dropdown-menu">-->
                    <!--<li>-->
                    ...
                    <!--</li>-->
                    <!-- <li class="dropdown">
                        <a href="#" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false">BỘ SƯU TẬP </a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href='#'><b>NỮ</b></a>
                                <ul>
                    ...
                    <!--<li class="dropdown">-->
                    <!--<a href="https://ivymoda.com/tim-kiem?hid_size=s&hid_color=&q=&sel_order=&hid_quantity_live=1" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false">Tìm theo size, màu</a>-->
                    <!--</li>-->
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="https://ivymoda.com/customer/login" title="Đăng nhập"><i class="fa fa-user" aria-hidden="true"></i></a></li>
                    <li class="dropdown">
    ...
    <!--NAV_MOBILE---------->
    <div id="nav_mobile">
        <a href="https://ivymoda.com/"><img src="public/images/logo.png" /></a>
        ...
        <div class="nav-side-menu">
            ...
            <div class="menu-list">
                <div class="login_mobile">
                    <a href="https://ivymoda.com/customer/login">Đăng nhập <i class="fa fa-user" aria-hidden="true"></i></a>
                </div>
                <ul id="menu-content" class="menu-content out">
                    ...
                    <li data-toggle="collapse" data-target="#shopOnline" class="collapsed">
                        <a>Thông tin</a> <span class="arrow"></span>
                    </li>
