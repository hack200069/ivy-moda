<form name="frm_cat" id="frm_cat" enctype="application/x-www-form-urlencoded" method="get" action="">
        ...
        <div class="container">
            ...
            <div class="col-md-3 col-sm-3 hidden-xs" id="">
                    ...
                    <div class="nav-side-menu menu-cat-left">
                        ...
                        <div class="menu-list collapse in" id="cat_col_name_1">
                    ...
                    <div class="nav-side-menu menu-cat-left">
                        ...
                        <div class="menu-list collapse in" id="cat_col_name_2">
                            <ul id="menu-content" class="menu-content out">
                                <?php
                                foreach (CATEGORY as $c) {
                                    if ($c['for_object'] == 1) {
                    ...
                    <div class="nav-side-menu menu-cat-left">
                        ...
                        <div class="menu-list collapse in" id="cat_col_name_3">
                            <ul id="menu-content" class="menu-content out">
                                <?php
                                foreach (CATEGORY as $c) {
                                    if ($c['for_object'] == 3) {
                ...
                <div class="col-md-9 col-sm-9">
                    <div class="row">
                        ...
                        <div class="col-md-12 last_products">
                            <div class="row">
                                <div id="phantrang" class="col-md-12 col-sm-12 text-right">
                                    <?php
                                    if ($total_pages > 1) {
                                        echo '<ul class="list-inline">';
                                        echo '<li><a href="' . SCRIPT_ROOT . '/tim-kiem?q=' . $q . '&page_no=1">Trang đầu</a></li>';
                                        if ($page_no == 1) {
                                            echo ' <li><a href="javascript:void(0)">&laquo;</a></li>';
                                        } else {
                                            echo ' <li><a href="' . SCRIPT_ROOT . '/tim-kiem?q=' . $q . '&page_no=' . ($page_no - 1) . '">&laquo;</a></li>';
                                        }
                                        for ($i = 1; $i <= $total_pages; $i++) {
                                            if ($page_no == $i)
                                                echo '<li><a href="javascript:void(0)" id="products_active_ts">' . $i . '</a></li>';
                                            else
                                                echo '<li><a href="' . SCRIPT_ROOT . '/tim-kiem?q=' . $q . '&page_no=' . $i . '">' . $i . '</a></li>';
                                        }
                                        if ($page_no == $total_pages) {
                                            echo ' <li><a href="javascript:void(0)">&raquo;</a></li>';
                                        } else {
                                            echo ' <li><a href="' . SCRIPT_ROOT . '/tim-kiem?q=' . $q . '&page_no=' . ($page_no + 1) . '">&raquo;</a></li>';
                                        }
                                        echo '<li><a href="' . SCRIPT_ROOT . '/tim-kiem?q=' . $q . '&page_no=' . $total_pages . '">Trang cuối</a></li>';
                                        echo '</ul>';
                                    }
                                    ?>
                                </div>
...
<script>
    document.title = "Tìm kiếm <?= $q ?> | IVY moda";
</script>